...
# for colour light signals - used where it is necessary for a train to slow
# down to take a diverging route. For "Approach on Red", the junction
...
# automatically changes to PROCEED, enabling the train to proceed along
# the divergent route. "Approach on Yellow" is used for when the speed
# restriction on the divergent route is less restrictive but still less

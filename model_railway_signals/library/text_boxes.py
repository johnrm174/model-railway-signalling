...
#   'textbox' - Reference to the Tkinter drawing object
...
def configure_edit_mode(edit_mode:bool):
    ...
    for text_box_id in text_boxes:
        ...
        if editing_enabled:
            ...
            text_box["canvas"].itemconfig(text_box["textbox"], state="normal")
            ...
            text_box["canvas"].itemconfig(text_box["textbox"], state="hidden")
...
def create_text_box(canvas, textbox_id:int, x:int, y:int, text:str, colour:str="black",
    ...
    canvas_tag = "textbox"+str(textbox_id)
    if not isinstance(textbox_id, int) or textbox_id < 1 or textbox_id > 999:
        ...
        text_boxes[str(textbox_id)]['textbox'] = text_box

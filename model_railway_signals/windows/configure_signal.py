...
#------------------------------------------------------------------------------------
    ...
    def load_state(self):
        ...
        if self.object_id not in objects.schematic_objects.keys():
            ...
            self.config.semaphores.lowerquadrant.set_value(objects.schematic_objects[self.object_id]["lowerquadrant"])
    ...
    def save_state(self, close_window):
        ...
        if self.object_id not in objects.schematic_objects.keys():
            ...
            if valid:
                ...
                new_object_configuration["lowerquadrant"] = self.config.semaphores.lowerquadrant.get_value()

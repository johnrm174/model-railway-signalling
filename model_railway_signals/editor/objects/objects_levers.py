...
#    levers.lever_exists - Common function to see if a given item exists
#    levers.delete_lever(id) - delete library drawing object (part of soft delete)
#    levers.create_lever(id) -  To create the library object (create or redraw)
#    levers.update_lever_styles(id,styles) - to change the styles of an existing lever
#
#------------------------------------------------------------------------------------
...
def redraw_lever_object(object_id, create_selected:bool=False):
    ...
    lever_type = levers.lever_type(objects_common.schematic_objects[object_id]["itemtype"])
...
def delete_lever_object(object_id):
    ...
    levers.delete_lever(objects_common.schematic_objects[object_id]["itemid"])
    return()

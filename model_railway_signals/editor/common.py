...
#    route_selections() - A fixed row of FIVE state_boxes representing possible signal routes
#    signal_route_selections() - combines int_item_id_entry_box and route selections (above)
#

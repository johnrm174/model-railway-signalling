...
def run_object_rotation_tests():
    ...
    assert_object_configuration(t1,{"vertical" : False})
    ...
    assert_object_configuration(t1,{"vertical" : True})
    assert_object_configuration(s1,{"orientation" : 90})
    assert_object_configuration(s2,{"orientation" : 90})
    assert_object_configuration(s3,{"orientation" : 90})
    assert_object_configuration(s4,{"orientation" : 90})
    assert_object_configuration(p1,{"orientation" : 90})
    assert_object_configuration(p2,{"orientation" : 90})
    rotate_selected_objects()
    assert_object_configuration(t1,{"vertical" : False})
    ...
    rotate_selected_objects()
    assert_object_configuration(t1,{"vertical" : True})
    assert_object_configuration(s1,{"orientation" : 270})
    assert_object_configuration(s2,{"orientation" : 270})
    assert_object_configuration(s3,{"orientation" : 270})
    assert_object_configuration(s4,{"orientation" : 270})
    assert_object_configuration(p1,{"orientation" : 270})
    assert_object_configuration(p2,{"orientation" : 270})
    rotate_selected_objects()
    assert_object_configuration(t1,{"vertical" : False})
    assert_object_configuration(s1,{"orientation" : 0})
    assert_object_configuration(s2,{"orientation" : 0})

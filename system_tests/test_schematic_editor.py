...
def run_basic_editor_tests(delay:float=0.0):
    print("Basic schematic editor tests - create and move schematic objects")
    ...
    sleep(delay)
    assert_objects_deselected(tb1,s1,s2,s3,s4,p1,p2,t1,l1,l2,i1)
    print("Basic schematic editor tests - Line editing")
    select_single_object(l1)
    sleep(delay)
    ...
    print("Basic schematic editor tests - Area selection and move of selected objects")
    ...
    print("Basic schematic editor tests - Copy and paste selected object (Cntl-c/Cntl-v)")

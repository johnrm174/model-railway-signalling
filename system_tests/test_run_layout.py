...
def run_override_tests(delay:float, automation_enabled:bool):
...
def run_interlocking_tests(delay:float, edit_mode:bool):
...
def run_layout_tests(delay:float, edit_mode:bool, automation_enabled:bool):
    run_interlocking_tests(delay, edit_mode=edit_mode)
    if not edit_mode: run_override_tests(delay, automation_enabled=automation_enabled)

...
def run_signal_override_tests():
    ...
    # Section 3 - Signals 2 and 4
    set_instrument_clear(2)
    set_sections_occupied(3)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(2)
    assert_signals_override_set(2)
    assert_signals_override_clear(1,3,4,5,6,7,8)
    set_signals_on(2)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(3,4)
    assert_signals_override_set(4)
    assert_signals_override_clear(1,3,2,5,6,7,8)
    set_signals_on(3,4)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_sections_clear(3)
    set_instrument_blocked(2)
    # Section 5 - signals 5 and 8
    set_instrument_clear(1)
    set_sections_occupied(5)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(5)
    assert_signals_override_set(5)
    assert_signals_override_clear(1,2,3,4,6,7, 8)
    set_signals_on(5)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(7,8)
    assert_signals_override_set(8)
    assert_signals_override_clear(1,2,3,4,5,6,7)
    set_signals_on(7,8)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    ...
    # Section 3 - signals 1 and 4
    set_instrument_clear(2)
    set_sections_occupied(3)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(1)
    assert_signals_override_set(1)
    assert_signals_override_clear(2,3,4,5,6,7,8)
    set_signals_on(1)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(3,4)
    assert_signals_override_set(4)
    assert_signals_override_clear(1,2,3,5,6,7,8)
    set_signals_on(3,4)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_sections_clear(3)
    set_instrument_blocked(2)
    ...
    # Section 5 - Signals 6 and 8
    set_instrument_clear(1)
    set_sections_occupied(5)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(6)
    assert_signals_override_set(6)
    assert_signals_override_clear(1,2,3,4,5,7,8)
    set_signals_on(6)
    assert_signals_override_clear(1,2,3,4,5,6,7,8)
    set_signals_off(7,8)
    assert_signals_override_set(8)

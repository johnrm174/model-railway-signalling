...
def run_all_tests():
    ...
    print("----------------------------------------------------------------------------------------")
    system_test_harness.run_function(lever_create_and_delete_tests, timeout=20.0)
    system_test_harness.run_function(lever_switching_tests, timeout=20.0)
    system_test_harness.run_function(lever_keypress_tests, timeout=20.0)
    system_test_harness.run_function(update_lever_styles_tests, timeout=20.0)
    system_test_harness.run_function(editor_mode_change_tests, timeout=20.0)

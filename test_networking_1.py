...
def middle_line_callback(item_id,callback_type):
    print ("Callback for mifddle line - Item: "+str(item_id)+" - Callback Type: "+str(callback_type))
...
map_traintech_signal (sig_id = 7, base_address = 107)
map_traintech_signal (sig_id = 6, base_address = 108)
map_traintech_signal (sig_id = 9, base_address = 109)

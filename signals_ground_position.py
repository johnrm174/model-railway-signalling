...
def create_ground_position_signal (canvas, sig_id:int, x:int, y:int,
    ...
    if sig_exists(sig_id):
        ...
        point_coords1 = rotate_point (x,y,0,-5,orientation) 
        point_coords2 = rotate_point (x,y,0,-25,orientation) 
        point_coords3 = rotate_point (x,y,+20,-25,orientation) 
        point_coords4 = rotate_point (x,y,+20,-20,orientation) 
        point_coords5 = rotate_point (x,y,+5,-5,orientation) 
